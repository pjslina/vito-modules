...
public class RedisRepository {
    ...
    /**
     * redis List数据结构 : 移除列表 key 的匹配元素
     *
     * @param key   the key 列表的键名
     * @param i     匹配元素要被移除的数量，可以为负数，表示从列表尾部开始往前查找
     * @param value 要移除的元素值
     * @return 被移除元素的数量
     */
     ...
     *
     * @param key  the key
     * @param list the list 一个或多个要插入到列表左侧的值
     * @return the long 返回插入后的列表长度
     */
    ...
    /**
     * redis Object数据结构 : 批量存储
     * 注意和上面方法的细微区别
     * @param key  the key
     * @param values the values 一个或多个要插入到列表左侧的值
     * @return the long 返回插入后的列表长度
     */
